...
! 
! THIS IS STILL A WORK IN PROGRESS as I test shit
!
...
for Minecraft 1.16.5, version 36.2.42. Later versions for 1.16.5 may also
...
```
java -jar forge-1.16.5-36.2.42.jar nogui
```
